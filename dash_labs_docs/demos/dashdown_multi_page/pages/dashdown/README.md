...
Use `dashdown` to deploy a README.md file.  It will execute the code blocks contained
...
app.layout = html.Div(dashdown("README.md", scope={"app": app}))
...
The following is an exerpt from the README.md file from: https://github.com/thedirtyfew/dash-extensions
...
@app.callback(Output("log", "children"), Input("el", "n_events"), State("el", "event"), prevent_initial_call=True)
